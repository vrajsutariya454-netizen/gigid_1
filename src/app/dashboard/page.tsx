    ...
    <div className="page-content min-h-screen pb-20">
      ...
      <div className="flex items-center justify-between mb-10">
        ...
        <button 
          ...
          className="p-3 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-color)] text-red-500 hover:bg-red-500/10 transition-colors"
        >
          <LogOut size={20} />
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <motion.div 
          ...
          className="card p-8 bg-gradient-to-br from-blue-600/10 to-teal-500/10 border-2 border-white/5"
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-black/20 border border-white/5">
              <Mail className="text-[var(--text-tertiary)]" size={18} />
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-[var(--text-tertiary)] uppercase tracking-widest">Email Address</span>
                <span className="text-sm font-bold text-white">{profile?.email}</span>
              </div>
            </div>

            <div className="flex items-center gap-4 p-4 rounded-2xl bg-black/20 border border-white/5">
              <LayoutDashboard className="text-[var(--text-tertiary)]" size={18} />
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-[var(--text-tertiary)] uppercase tracking-widest">Account Status</span>
                <span className="text-sm font-bold text-teal-400">Verified Secure</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button 
            ...
            className="p-6 rounded-3xl bg-[var(--bg-elevated)] border border-[var(--border-color)] text-center group active:scale-95 transition-all"
          >
            <User className="mx-auto mb-3 text-blue-500 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black uppercase tracking-widest text-[var(--text-secondary)]">Edit Profile</span>
          </button>
          <button 
            onClick={() => router.push('/home')}
            className="p-6 rounded-3xl bg-[var(--bg-elevated)] border border-[var(--border-color)] text-center group active:scale-95 transition-all"
          >
            <ShieldCheck className="mx-auto mb-3 text-teal-500 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black uppercase tracking-widest text-[var(--text-secondary)]">Identity Score</span>
          </button>
        </div>
      </div>
    </div>
